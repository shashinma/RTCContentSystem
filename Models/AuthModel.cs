...
public class LoginModelAlt : PageModel
{
    private readonly SignInManager<IdentityUser> _signInManager;
    private readonly ILogger<LoginModelAlt> _logger;

    public LoginModelAlt(SignInManager<IdentityUser> signInManager, ILogger<LoginModelAlt> logger)
    {
...
public class RegisterModelAlt : PageModel
{
    private readonly SignInManager<IdentityUser> _signInManager;
    private readonly UserManager<IdentityUser> _userManager;
    private readonly IUserStore<IdentityUser> _userStore;
    private readonly IUserEmailStore<IdentityUser> _emailStore;
    private readonly ILogger<RegisterModelAlt> _logger;
    private readonly IEmailSender _emailSender;

    public RegisterModelAlt(
        UserManager<IdentityUser> userManager,
        IUserStore<IdentityUser> userStore,
        SignInManager<IdentityUser> signInManager,
        ILogger<RegisterModelAlt> logger,
